...
/**
 * Class ClusterMetricNodeCapacity.
 *
 * This class is the model for cluster node metric capacities.
 *
 ...
 */
class ClusterMetricNodeCapacity extends Model
{
    use SoftDeletes;
    use HasUuids;
     ...
     * @var string
     */
    protected $table = 'cluster_metric_node_capacities';
