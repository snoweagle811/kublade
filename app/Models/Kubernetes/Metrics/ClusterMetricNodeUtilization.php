...
/**
 * Class ClusterMetricNodeUtilization.
 *
 * This class is the model for cluster node metric utilizations.
 *
 ...
 */
class ClusterMetricNodeUtilization extends Model
{
    use SoftDeletes;
    use HasUuids;
     ...
     * @var string
     */
    protected $table = 'cluster_metric_node_utilizations';
