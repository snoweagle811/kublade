...
/**
 * Class ClusterMetricUtilization.
 *
 * This class is the model for cluster metric utilizations.
 *
 ...
 */
class ClusterMetricUtilization extends Model
{
    use SoftDeletes;
    use HasUuids;
     ...
     * @var string
     */
    protected $table = 'cluster_metric_utilizations';
