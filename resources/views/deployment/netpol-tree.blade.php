<div class="d-flex flex-column gap-2">
    <div class="d-flex justify-content-between align-items-start flex-row file-tree-li">
        ...
        <div class="file-tree-li-actions">
            <a href="{{ route('deployment.details', ['project_id' => $deployment->project_id, 'deployment_id' => $deployment->id, 'tab' => 'network-policies', 'network_policy_id' => 'new']) }}" class="btn btn-sm btn-primary p-1 lh-1">
