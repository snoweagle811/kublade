<li>
    <div class="d-flex justify-content-between align-items-start flex-row file-tree-li">
        ...
        <div class="file-tree-li-actions">
            <a href="{{ route('template.file.add', ['template_id' => $template->id, 'folder_id' => $structure->id]) }}" class="btn btn-sm btn-primary p-1 lh-1">
                <i class="bi bi-file-earmark-plus file-tree-action"></i>
            </a>
            <a href="{{ route('template.folder.add', ['template_id' => $template->id, 'folder_id' => $structure->id]) }}" class="btn btn-sm btn-primary p-1 lh-1">
                <i class="bi bi-folder-plus file-tree-action"></i>
            </a>
            <a href="{{ route('template.folder.update', ['template_id' => $template->id, 'folder_id' => $structure->id]) }}" class="btn btn-sm btn-warning text-white p-1 lh-1">
                <i class="bi bi-pencil file-tree-action"></i>
            </a>
            <a href="{{ route('template.folder.delete.action', ['template_id' => $template->id, 'folder_id' => $structure->id]) }}" class="btn btn-sm btn-danger text-white p-1 lh-1">
